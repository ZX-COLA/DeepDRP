...
def encode_by_pssm(fasta_file):
    ...
    if not os.path.exists(pssm_file):
        ...
        run_blast = "{} -query {} -num_threads 8 -db ./lib/uniref50.fasta/uniref50.fasta -num_iterations 3 -out ./tmp/{}.txt -out_ascii_pssm ./tmp/{}.pssm".format(
            balst_path, fasta_file, id, id)
        os.system(run_blast)
